...
public class SudokuTest {
	...
	public void jogarNaGrade1x1oValor8NaPosicao1x1() {
		Tabuleiro tabuleiro = new Sudoku().comGridsTamanho(3,3);
		Grid grid1x1 = tabuleiro.jogarNaGridDe(new Posicao(1,1)).valor(8).para(new Posicao(1, 1));
		assertEquals(8, grid1x1.getValorNa(new Posicao(1, 1)));
	...
	public void jogarNaGrade2x1oValor5NaPosicao1x1() {
		Tabuleiro tabuleiro = new Sudoku().comGridsTamanho(3,3);
		Grid grid1x1 = tabuleiro.jogarNaGridDe(new Posicao(2,1)).valor(5).para(new Posicao(1, 1));
		assertEquals(5, grid1x1.getValorNa(new Posicao(2, 1)));
